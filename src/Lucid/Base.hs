...
-- | With the given element, add the given attributes. Duplicate
-- attributes are allowed.
with :: (Html () -> Html ()) -- ^ The element(s) to assign the attributes to.
     -> [Attr]               -- ^ Attributes to append. Duplicates permitted.
     -> Html () -> Html ()   -- ^ A new element(s) with the assigned attributes.
with f =
  \attr inner ->
